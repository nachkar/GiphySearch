...
struct Fixed_height_small: JSONCompatible {
    var height: String
    var mp4_size: String
    var mp4: String
    ...
    init(height: String, mp4_size: String, mp4: String, webp_size: String, width: String, webp: String, size: String, url: String) {
        self.height = height
